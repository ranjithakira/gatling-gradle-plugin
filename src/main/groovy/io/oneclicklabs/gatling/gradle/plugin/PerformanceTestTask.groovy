 ...
 */
class PerformanceTestTask extends JavaExec {
    ...
    void exec() {
        ...
        if (getSimulations() instanceof Closure<Iterable<String>>) {
            actualSimulations = project.extensions.getByType(PluginExtension).resolveSimulations(getSimulations())
